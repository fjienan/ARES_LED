...
def test_build_wled_idle_effect_json_uses_static_segment_topology_for_colorloop():
    specs = build_triplet_segment_specs(
        code_length=3,
        low_segments=[0, 1, 2],
        low_brightness=6.0,
    ...
    payload = build_wled_idle_effect_json(
        display_segments=specs,
        pixel_count=6,
        brightness=20.0,
        effect=8,
        speed=64,
        intensity=128,
        master_brightness=255.0,
    )

    assert payload == (
        '{"on":true,"bri":255,"tt":0,"seg":['
        '{"id":0,"start":0,"stop":1,"fx":8,"sx":64,"ix":128,"bri":20},'
        '{"id":1,"start":1,"stop":2,"fx":8,"sx":64,"ix":128,"bri":20},'
        '{"id":2,"start":2,"stop":3,"fx":8,"sx":64,"ix":128,"bri":20},'
        '{"id":3,"start":3,"stop":4,"fx":8,"sx":64,"ix":128,"bri":20},'
        '{"id":4,"start":4,"stop":5,"fx":8,"sx":64,"ix":128,"bri":20},'
        '{"id":5,"start":5,"stop":6,"fx":8,"sx":64,"ix":128,"bri":20}'
        ']}'
    )


def test_build_wled_idle_effect_json_rejects_invalid_segment_range():
